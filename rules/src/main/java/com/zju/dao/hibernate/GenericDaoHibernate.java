 ...
 * <pre>
 *      &lt;bean id="fooDao" class="zju.lis.dao.hibernate.GenericDaoHibernate"&gt;
 *          &lt;constructor-arg value="zju.lis.model.Foo"/&gt;
 *      &lt;/bean&gt;
 * </pre>
 *
...
public class GenericDaoHibernate<T, PK extends Serializable> implements GenericDao<T, PK> {
    ...
    public T get(PK id) {
        ...
        if (entity == null) {
            ...
            String msg=ResourceBundle.getBundle(Constants.BUNDLE_KEY, locale)
    				.getString("patients.notExist").replace("{0}", (CharSequence) id);
			throw new ObjectRetrievalFailureException(this.persistentClass, id, msg, null);
