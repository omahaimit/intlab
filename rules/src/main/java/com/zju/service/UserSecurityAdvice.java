...
public class UserSecurityAdvice implements MethodBeforeAdvice, AfterReturningAdvice {
    ...
    public static final String EDIT_DENIED = "Access Denied: Only administrators are allowed to modify this field.";
        ...
        if (ctx.getAuthentication() != null) {
            ...
            if (!signupUser) {
                ...
                if (user.getId() != null && !user.getId().equals(currentUser.getId()) && !administrator) {
                    ...
                    if (!StringUtils.equals(user.getDepartment(),currentUser.getDepartment())) {
                    	log.warn("Access Denied: '" + currentUser.getUsername() + "' tried to change department!");
                        throw new AccessDeniedException(EDIT_DENIED);
                    }
                    
                    if (!StringUtils.equals(user.getLabCode(),currentUser.getLabCode())) {
                    	log.warn("Access Denied: '" + currentUser.getUsername() + "' tried to change labCode!");
                        throw new AccessDeniedException(EDIT_DENIED);
                    }
                }
            } else {
